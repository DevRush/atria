...
export type HolidayWhereInput = {
  ...
  date?: Prisma.StringFilter<"Holiday"> | string
...
export type HolidayScalarWhereWithAggregatesInput = {
  ...
  date?: Prisma.StringWithAggregatesFilter<"Holiday"> | string
...
export type HolidayOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"date" | "name", ExtArgs["result"]["holiday"]>
...
export interface HolidayDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
   ...
   * const holidayWithDateOnly = await prisma.holiday.createManyAndReturn({
   *   select: { date: true },
   *   data: [
   *     // ... provide data here
   *   ]
   ...
   * const holidayWithDateOnly = await prisma.holiday.updateManyAndReturn({
   *   select: { date: true },
   *   where: {
   *     // ... provide filter here
   *   },
...
export interface HolidayFieldRefs {
  readonly date: Prisma.FieldRef<"Holiday", 'String'>
